...
public:
    std::string inicio;
    std::string id;
    CommentStatment(std::string id, std::string inicio)
...
public:
    ...
    FunDecList *fundecs;
    string nombre;
    Program(UsesList* uses,VarDecList *vardecs, FunDecList *fundecs, string nombre = "main");
    int accept(Visitor *v);
    void accept(ImpValueVisitor *v);
    void accept(TypeVisitor *v);
    ~Program();
